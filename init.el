...
(use-package meow
  ...
  (defun my-meow-setup ()
    ...
    (meow-leader-define-key
     ...
     '("j a" . xref-find-apropos)
     '("j b" . xref-go-back)
     '("j d" . xref-find-definitions)
     '("j D" . eglot-find-declaration)
     '("j i" . eglot-find-implementation)
     ...
     '("o a" . org-agenda)
     '("o c" . org-capture)
     '("o i" . eglot-code-action-organize-imports)
     '("o l" . org-store-link)
...
;;; Extras (optional, disabled by default -- see extras.el)
